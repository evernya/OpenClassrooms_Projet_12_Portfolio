...
export default function Navigation() {
    ...
    return (
        <div className="nav-item__link--pf">
            <NavLink to="/"  className={({ isActive }) => `nav-item__link--pf-home ${isActive ? 'link--pf-home-active' : ''}`}>Accueil</NavLink>
            ...
            <NavLink to="/about" className={({ isActive }) => `nav-item__link--pf-about ${isActive ? 'link--pf-about-active' : ''}`}>À propos</NavLink>
